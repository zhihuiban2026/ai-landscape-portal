export const tools = [
  ...
  { id:'landscape-design', name:'AI 景觀設計研究', owner:'陳芅睿', url:'https://landscape-mci8.onrender.com/', domains:['景觀設計','基地分析','場地規劃'], keywords:['景觀設計','景觀分析','場地規劃','基地分析','景觀研究','戶外','庭園','公園','校園','廣場','開放空間','動線','分區','設計概念','設計策略','水景','鋪面','節點','視線','使用者分析'], prompt:'適合處理景觀設計、基地分析、場地規劃、空間分區、動線與整體設計策略。' }
];
const synonyms = {
  '植物':['植栽','花草','盆栽','綠化','植被'],
  '陽台':['露台','窗台','半戶外'],
